...
public abstract class MapObject {
	...
	public Rectangle getRectangle(){
		return new Rectangle(new Rectangle((int) x - cwidth, (int) y - cheight, cwidth, cheight));
	}
	...
	public boolean notOnScreen() {
		return x + xmap + width < 0 || x + xmap - width > Game.kWIDTH || y + ymap + height < 0 || y + ymap - height > Game.kHEIGHT;
	}
}
